...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8">
        <title>Recuperar Credenciales | DSI - Mesa de Partes</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Recupere la contraseña a travez de su Correo Electrónico registrado.</p>
                                        </div>
                                        <div class="alert alert-success text-center mb-4 mt-4 pt-2" role="alert">
                                            Ingrese su correo para enviarle instrucciones!
                                        </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Recordó su contraseña?<a href="../../" class="text-primary fw-semibold">Inicie Sesión </a> </p>
                                        </div>
                                    </div>
